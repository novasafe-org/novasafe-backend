...
const MASTER_KEY = process.env.MOBILE_VAULT_MASTER_KEY || process.env.SERVER_MASTER_KEY || 'novasafe-mobile-default-master-key';
...
export const encryptPayload = (data: Record<string, any>): EncryptedPayload => {
...
export const encryptText = (value: string): { encrypted_data: string; iv: string; authTag: string } => {
